...
I'm an Engineering Manager and Frontend Architect with **10+ years** of experience building web platforms at scale. I lead cross-functional teams, design frontend architectures, and drive technical strategy — from early-stage startups to large enterprise products.

Currently based in **Valencia, Spain** 🇪🇸, I've worked across multiple countries and time zones, managing distributed teams and delivering products used by millions.

- 🏗️ &nbsp;Led engineering teams of **up to 30 engineers** across frontend, backend & QA
- 🚀 &nbsp;Scaled platforms from **0 → 10M+ users** with high-performance architectures
- 🎯 &nbsp;Passionate about **developer experience**, design systems, and frontend performance
- 🌍 &nbsp;Experienced across fintech, e-commerce, media, and real estate domains
...
**🏢 Leadership**
- Engineering Manager at top-tier companies
- Built and led teams of 5–30 engineers
- Defined tech strategy and roadmaps
- Mentored senior & staff-level engineers

</td>
<td width="50%">

**⚡ Technical Impact**
- Architected micro-frontend platforms
- Designed component libraries & design systems
- Delivered 40%+ performance improvements
- Migrated legacy monoliths to modern stacks
...
🇬🇧 English (Fluent) · 🇺🇦 Ukrainian (Native) · 🇷🇺 Russian (Native) · 🇪🇸 Spanish (Intermediate)
